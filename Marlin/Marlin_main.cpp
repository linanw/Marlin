...
void home_all_axes() { gcode_G28(true); }
  ...
  /*
   * G35 - IR Probe Calibration based on M206
   *
   * Automatically sets M851 based on a stored M206 value
   * This will adjust the probe offset based upon the trigger distance of the probe.
   *
   * Adjust the M851 probe offset for ambient lighting levels or even the color of the bed,
   * this will probe one point on the bed to measure the trigger distance of the IR sensor,
   then set that trigger distance as the probe offset.
   *
  ...
  inline void gcode_G35() {
   ...
   /*
   * G36 - Autolevel sequence for Robo
   *
   * A combination of G28 + G35 + G29
   */
