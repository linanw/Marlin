...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,800,145.5}  // default steps per unit for Robo C2
...
#define Z_PROBE_TRAVEL_HEIGHT  25 // Z position for travel between points
